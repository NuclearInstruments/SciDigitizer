...
'        Statistics_ReLoad(MainForm.oscilloscope.CHList.Count)
'    End Sub
...
'            chgroup.Text = MainForm.oscilloscope.CHList(i).name '"CHANNEL " & (i + 1).ToString
'            chgroup.Width = 260
'            chgroup.Height = 110
...
'            icrocrtext(i).Text = MainForm.oscilloscope.CHList(i).stat.icr & " / " & MainForm.oscilloscope.CHList(i).stat.ocr
'            toteventsinouttext(i).Text = MainForm.oscilloscope.CHList(i).stat.toteventin & " / " & MainForm.oscilloscope.CHList(i).stat.toteventout
'            deadtimetext(i).Text = MainForm.oscilloscope.CHList(i).stat.deadtime
'        Next
'    End Sub
'End Class
